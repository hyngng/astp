...
- 한국투자증권 Open API 활용  
- 미국 주식거래에 특화  
- [야후 금융 페이지](https://finance.yahoo.com/quote/NQ=F?p=NQ=F&.tsrc=fin-srch) 크롤링을 통한 NASDAQ-100 지수 활용  
- NASDAQ 상장 상위 10개 기업 리스트 활용  

<h4>사전작업</h4>

- 한국투자증권 계좌 개설하기  
- [한국투자증권 API(eFriend Expert)](https://www.truefriend.com/main/customer/systemdown/OpenAPI.jsp?cmd=TF04ea01200)를 다운 및 설치하기  

<h4>주의사항</h4>

- 한국투자증권 계좌개설 및 해당 계좌로 API 신청 후 APP Key, APP Secret 발급 필수  
    - 모의계좌도 예외없이 필수로 APP Key, APP Secet 발급을 받아야 한다.  
- 공동인증서 모듈의 64bit 미지원 이슈로 코드를 32bit 가상환경에서 실행할 필요가 있다.
